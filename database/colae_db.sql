...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 23, 2025 at 02:55 AM
...
--
ALTER TABLE `venue_images` ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE `sports` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `venues` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `venue_images`
--
ALTER TABLE `venue_images` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `venues` ADD CONSTRAINT `venues_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `venue_images` ADD CONSTRAINT `venue_images_ibfk_1` FOREIGN KEY (`venue_id`) REFERENCES `venues` (`id`) ON DELETE CASCADE;
