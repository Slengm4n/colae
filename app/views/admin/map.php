...
<body class="bg-[#0D1117] text-gray-200">
    ...
    <div class="flex h-screen overflow-hidden">
        <!-- Sidebar -->
        <aside class="w-64 flex-shrink-0 bg-[#161B22] border-r border-gray-800 flex flex-col">
            ...
            <div class="p-4 border-t border-gray-800">
                <a href="#" class="flex items-center gap-4 px-4 py-3 text-sm font-semibold text-red-400 hover:bg-red-500/10 rounded-lg transition-colors"><i class="fas fa-sign-out-alt w-5 text-center"></i><span>Sair</span></a>
            </div>
        </aside>
        ...
        <main class="flex-1 relative">
            ...
            <!-- Search Bar Overlay -->
            <div class="absolute top-6 left-1/2 -translate-x-1/2 z-10 w-full max-w-md px-4">
                <div class="relative bg-[#161B22] border border-gray-700 rounded-lg shadow-lg">
                    <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                        <i class="fas fa-search text-gray-500"></i>
                    </div>
                    <input type="text" id="venue-search-input" placeholder="Buscar pelo nome do local..." class="block w-full rounded-lg border-0 bg-transparent py-3 pl-10 pr-3 text-gray-200 placeholder:text-gray-500 focus:ring-2 focus:ring-inset focus:ring-cyan-500 sm:text-sm">
                    <div id="venue-search-results" class="absolute mt-1 w-full bg-[#161B22] border border-gray-700 rounded-lg shadow-lg z-20 hidden"></div>
                </div>
            </div>

            <!-- Venue Info Sidebar -->
            <div id="venue-sidebar" class="absolute top-0 right-0 h-full w-full max-w-sm bg-[#161B22] shadow-lg p-6 transform transition-transform duration-300 ease-in-out translate-x-full z-20 border-l border-gray-800">
    ...
    <script>
        ...
        function initMap() {
            ...
            const mapStyle = [{
                ...
                // AQUI ESTÁ A MUDANÇA: Oculta pontos de interesse e trânsito
                {
                    featureType: "poi",
                    elementType: "all",
                    stylers: [{
