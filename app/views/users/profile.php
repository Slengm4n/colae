                    ...
                    <?php if (isset($data['user'])): $user = $data['user']; ?>
                        <form action="<?php echo BASE_URL; ?>/profile/update" method="POST" class="space-y-6">
                            ...
                            <div class="flex items-center gap-6">
                                <img src="https://placehold.co/100x100/1f2937/9ca3af?text=Foto" alt="Foto do perfil" class="w-24 h-24 object-cover rounded-full">
                                <div>
                                    <button type="button" class="bg-cyan-500 hover:bg-cyan-400 text-black font-bold py-2 px-4 rounded-lg text-sm transition-colors">
                                        Carregar Nova Foto
                                    </button>
